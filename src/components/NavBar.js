    ...
    <header className="w-full px-32 py-8 font-medium flex justify-between items-center dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink href="/projects" title="Projects" className="ml-10" />
        </nav>

        <nav className="flex items-center justify-center flex-wrap gap-4">
          <motion.a
            href="https://www.linkedin.com/in/phoebe-su"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://www.github.com/phoebesu1025"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
          ...
          <motion.a
            href="https://www.youtube.com/channel/UCfZf-tGuPXyd8iW2KtX6lKg"
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6"
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap  mt-2">
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mr-3 sm:mx-1 bg-light rounded-full"
            >
              <LinkedInIcon />
            </motion.a>
            <motion.a
